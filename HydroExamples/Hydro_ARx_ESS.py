...
def model_builder(stage):
    ...
    if stage == 0:
        ...
        for v in inflow0:
            inflow0[v].lb = 0
            inflow0[v].ub = 0
            inflow[v].lb = 0#initial_inflow[-1][v]
            inflow[v].ub = 0#initial_inflow[-1][v]
...
if __name__ == '__main__':
    sddp_log.addHandler(logging.FileHandler("HydroAR_ESS.log", mode='w'))
    argv = sys.argv
    ...
    for nr in [3]:#,10,50,100,500,1000]:
